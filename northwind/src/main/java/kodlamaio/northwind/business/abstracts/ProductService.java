...
public interface ProductService {
	...
	DataResult<Product> getByProductNameAndCategoryId(String productName,int cateoryId);
	
	DataResult<List<Product>>  getByProductNameOrCategoryId(String productName,int cateoryId);
